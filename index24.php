          ...
          <div class="col-md-9 order-2">
			...
			<?php
				...
				/*for ($i=0;$i<50;$i++){
					...
					$conexion->query("insert into  productos (nombre,descripcion,precio,imagen,inventario,id_categoria,talla,color) values('producto $i','esta es la descripcion',".rand(10,3000).",'cintas.png',".rand(1,100).",'1','XL','blue'
				...
				$totalProducts = mysqli_fetch_row($totalquery);
				$totalButtons = round($totalProducts[0]/$limite);
