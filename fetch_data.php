...
if (!empty($_GET['text'])){
		...
		$resultado1 = $conexion ->query("select productos.*, categorias.nombre as categoria from productos
	...
	if(isset($_POST['typo'],$_POST['marca'], $_POST['talla'],$_POST['color'],$_POST['catego'],$_POST['preciomin'],$_POST['preciomax'])) 
	...
	$resultado1 = $conexion ->query("select * from productos  where 
	                                    precioM > ".$min." and 
										
		        nombre like '%".$_POST['marca']."%' and
		
				genero like '%".$_POST['catego']."%' and
				
		       talla like '%".$_POST['talla']."%' and
			   
			   id_categoria like '%".$_POST['typo']."%' and
			   
				color like '%".$_POST['color']."%' and
				
			   precioM < ".$max)or die ($conexion -> error);
	  ...
	  <?php 
			 ...
			 <p class="font-weight-bold" style="color:black; font-size: 170%;">$<?php echo $fila['precio'];?></p>
				<?php
				 ...
				 <p class="font-weight-bold" style="color:black; font-size: 170%;">$<?php echo $fila['precioUnitario'];?></p>
	 ...
	 <div class="col-sm-4">
                        ...
                        <div class="sidebar-widget brands">
                            ...
                            <ul>
                                ...
                                <li><a href="./fetch_data.php?text=utiluno">Util uno</a><span>(74)</span></li>
